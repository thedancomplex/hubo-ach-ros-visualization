...
class JointStatePublisher:
    ...
    def __init__(self):
        ...
        self.hubo_sub = rospy.Subscriber("/Hubo/HuboCommand", HuboCommand, self.hubo_cb)
        #Setup the joint state publisher
        self.hubo_pub = rospy.Publisher('/robot_2/joint_states', JointState)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if (time_difference > threshold):
                print "*** WARNING - Hubo commands are old ***"
...
if __name__ == '__main__':
    rospy.init_node('joint_state_publisher_feedforward_both')
